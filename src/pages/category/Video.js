...
import { videoData } from "../../constants/category";
    ...
    <div className=" w-full pt-60 pb-20 text-center lg:text-left flex flex-wrap">
      ...
      <div className="w-full mt-16">
        ...
        <div className="w-full mt-4">
          {
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
              {videoData.endingSoon.map((recentItem, recentIndex) => {
                return (
                  <NFTCard
                    cardData={recentItem}
        ...
        <div className="w-full mt-4">
          {
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
              {videoData.newlyMinted.map((newItem, newIndex) => {
        ...
        <div className="w-full mt-4">
          {
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
              {videoData.onAuction.map((auctionItem, auctionIndex) => {
                return (
